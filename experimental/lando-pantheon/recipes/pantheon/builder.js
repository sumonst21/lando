...
module.exports = {
  ...
  builder: (parent, config) => class LandoPlatformsh extends parent {
    constructor(id, options = {}) {
      ...
      // Get the pantheon config weve loaded and parsed
      const pantheonConfig = _.get(options, '_app.pantheon', {});
      // Combine application and service containers
      const services = _.flatten([pantheonConfig.appserver, pantheonConfig.services]);

      // Map into lando services
      options.services = getLandoServices(services);
